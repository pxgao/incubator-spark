...
object NetworkTest {
  def main(args: Array[String]) {
    ...
    val ssc = new StreamingContext(args(0), "NetworkTest", Seconds(1),
...
//
//    val gb = x.combineByKey[Int](s => 1, (c,s) => (c+1), (c1,c2) => (c1+c2), new HashPartitioner(ssc.sc.defaultParallelism))
